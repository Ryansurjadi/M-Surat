  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <input action="action" onclick="window.history.go(-1); return false;" type="button"  class="btn btn-danger" value="Kembali" />
       &nbsp; &nbsp; &nbsp;
          <a href="<?php echo site_url('Tugas/download_hasil_tugas/'.$pertemuan[0]['Id_kelas'].'/'.$pertemuan[0]['Pertemuan'].'/'.$pertemuan[0]['Id_tugas']);?>" class="btn btn-success"><i class="plus"></i>Download Tugas</a>
...
$(document).ready(function() {
    ...
    var table = $('#userData').DataTable({ 
            ...
            "ajax": {
                "url": '<?php echo site_url('Tugas/jsonHasilTugasMahasiswa/'.$params1.'/'.$params2); ?>',
                "type": "POST"
            },
