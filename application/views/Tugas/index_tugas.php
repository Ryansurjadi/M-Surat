          ...
          <?php if(!empty($tugas_kuliah)) { ?>
              <?php foreach($tugas_kuliah as $row){ ?>
                ...
                <div class="box box-solid box-primary collapsed-box">
                    ...
                    <div class="box-body">
                      <a href="<?php echo site_url('Tugas/viewTugas/'.$row['Id']);?>" class="btn btn-success" style="float:right;" ><i class="plus"></i>Lihat Tugas</a>
                    </div><!-- /.box-body -->
                </div>
              <?php } ?>
          <?php }else{ ?>
              <div class="box box-solid box-primary">
                  <div class="box-header with-border">
                      <h3 class="box-title">Belum Ada Jadwal , Belum Bisa Lihat Tugas</h3>
              </div>
          <?php } ?> 
          </div>
