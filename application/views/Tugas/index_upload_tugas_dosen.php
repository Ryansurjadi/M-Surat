  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="float-right">
          <a href="#" class="btn btn-success" data-type="add" data-toggle="modal" data-target="#modalUserAddEdit"><i class="plus"></i>Tambah Tugas</a>
         &nbsp; &nbsp; &nbsp;
      </div>
      <br>
      <!-- Main row -->
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <?php echo form_open_multipart('Tugas/add','role="form" ');?>
                              ...
                              <div class="row">
                                    <div class="col-md-12">
                                      <div class="input-group date" >
                                        <label>Tanggal Kumpul</label>
                                        <input type="text" class="form-control pull-right" name="selesai" id="selesai" placeholder="Masukan Tanggal Kumpul">
                                      </div>
                                    </div>
                              </div>
                            </div>
...
//   }, 3000);
    ...
    var table = $('#userData').DataTable({ 
            ...
            "ajax": {
                "url": '<?php echo site_url('Tugas/jsonUploadTugas/'.$params); ?>',
                "type": "POST"
            },
            ...
            "columns": [
                ...
                {"data": null,
                    render: function ( data, type, row ) {
                    // Combine the first and last names into a single table field
                    return data.Deskripsi.substr(0,40);
                    }
                },
                {"data": null,
                    render: function ( data, type, row ) {
                    // Combine the first and last names into a single table field
                    return data.File.substr(10,50);
                    }
                },
                {"data": "action"},
            ],
