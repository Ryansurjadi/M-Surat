    ...
    <section class="content">
      ...
      <div class="row">
        <section class="col-lg-12">
            <form id="form_check" action="<?php echo site_url('Jadwalujian/getJadwalUjian'); ?>" method="POST">
...
<script>
  $(document).ready(function() {
      ...
      var table = $('#Kelas').DataTable({ 
              ...
              "ajax": {
                  "url": '<?php echo site_url('Jadwalujian/jsonUjian'); ?>',
                  "type": "POST"
              },
              "scrollY":        400,
              "scrollCollapse": true,
      ...
      $('#form_check').on('submit', function(e){
          ...
          $.ajax({
          type: "POST",
          url: "<?php echo site_url('Jadwalujian/getJadwalUjian'); ?>",
