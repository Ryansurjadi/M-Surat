  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="float-right">
          <a href="#" class="btn btn-success" data-type="add_tipe" data-toggle="modal" data-target="#modalUserAddEdit"><i class="plus"></i>Tambah Tipe Dokumen</a>
      </div>
      <br>
      <!-- Main row -->
      <div class="row">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <?php echo form_open_multipart('Dokumen/add_tipe','role="form" ');?>
                        <input type="hidden" class="form-control" name="id" id="id"/>
                            <div class="form-group">
                                <label>Tipe Dokumen</label>
                                <input type="text" class="form-control" name="nomor" id="nomor" placeholder="Masukan Tipe Dokumen" >
                            </div>
                            <div class="form-group">
                                <label>Nama Tipe Dokumen</label>
                                <input type="text" class="form-control" name="judul" id="judul" placeholder="Masukan Nama Tipe Dokumen" >
                            </div>
...
<script>
    ...
    $(function () {
        $('#modalUserAddEdit').on('show.bs.modal', function (e) {
            ...
            var userFunc = "userAction('add_tipe');";
            $('#hlabel').text('Tambah');
            $('.show123').hide();
...
$(document).ready(function() {
    ...
    var table = $('#userData').DataTable({ 
            ...
            "ajax": {
                "url": '<?php echo site_url('Dokumen/jsonDataTipe'); ?>',
                "type": "POST"
            },
