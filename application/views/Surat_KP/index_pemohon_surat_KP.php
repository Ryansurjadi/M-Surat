...
$(document).ready(function() {
    ...
    var table = $('#userData').DataTable({ 
            ...
            "ajax": {
                "url": '<?php echo site_url('Surat_KP/jsonData'); ?>',
                "type": "POST"
            },
            "bInfo" : false,
            ...
            "columns": [
                ...
                {"data": null,
                    ...
                    // Combine the first and last names into a single table field
                        if(data.Status == '0'){
                            return '<center><label class="label bg-red">Belum di Proses</label></center>';
                        }
                        else if(data.Status == '1'){
                            return '<center><label class="label bg-yellow">Sedang di Proses</label></center>';
                        }
                        else if(data.Status == '2'){
                            return '<center><label class="label bg-green">Selesai di Proses</label></center>';
                        }
                    }
                },
                {"data": "action"},
