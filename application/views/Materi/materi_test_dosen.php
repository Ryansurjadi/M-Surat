  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="row">
        ...
        <div class="row">
          <div class="col-md-8">
              <?php foreach($materi_kuliah as $row){ ?>
                <br>
                <div class="box box-solid box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"><?php echo $row['Matakuliah']; ?> <?php echo " - " ; echo "(Kelas ".$row['Kelas'].")"?></h3>
                    </div><!-- /.box-header -->
                    <div class="box-body">
                      <div style="float:right;">
                        <a href="<?php echo site_url('Materi/upload_materi_dosen/'.$row['Id']);?>" class="btn btn-success"  ><i class="plus"></i>Upload Materi</a>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="<?php echo site_url('Tugas/upload_tugas_dosen/'.$row['Id']);?>" class="btn btn-default"  ><i class="plus"></i>Upload Tugas</a>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="<?php echo site_url('Tugas/lihat_tugas_pertemuan/'.$row['Id']);?>" class="btn btn-info"  ><i class="plus"></i>Lihat Tugas</a>
                      </div>
