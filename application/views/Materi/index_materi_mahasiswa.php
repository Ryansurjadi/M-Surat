            ...
            <?php if(!empty($materi_kuliah)) { ?>
              <?php foreach($materi_kuliah as $row){ ?>
                ...
                <div class="box box-solid box-primary collapsed-box">
                    ...
                    <div class="box-body">
                      <a href="<?php echo site_url('Materi/viewMateri/'.$row['Id']);?>" class="btn btn-success" style="float:right;" ><i class="plus"></i>Buka Materi</a>
                    </div><!-- /.box-body -->
                </div>
              <?php } ?>
            <?php }else{ ?>
              <div class="box box-solid box-primary">
                  <div class="box-header with-border">
                      <h3 class="box-title">Belum Ada Jadwal , Belum Bisa Lihat Materi</h3>
              </div>
            <?php } ?> 
          </div>
